...
$base  = 'http'.$ssl_set.'://'.$_SERVER['HTTP_HOST'];
$base .= str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
$config['sub_base_url'] = $base;
$config['base_url_admin'] = $base.'/';

$config['base_url'] = 'http'.$ssl_set.'://'.$domainName.'/';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
if(liveMode == 'on')
{
	$config['cookie_prefix']	= $Name."_";//$domainName
...
//$config['company_name'] = $this->CI->site_config_model->getsite_configInfo(1); 
