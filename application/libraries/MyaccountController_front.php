 ...
 */
class MyaccountController_front extends CI_Controller {
	protected $role = '';
	protected $vendorId = '';
	protected $name = '';
	protected $roleText = '';
	...
	public function __construct()
    {
        parent::__construct();	
      	...
      	$userisLoggedIn = $this->session->userdata('logged_in');
    ...
    function loadViews($viewName = "", $headerInfo = NULL, $pageInfo = NULL, $footerInfo = NULL){
        ...
        $this->load->view('myaccount_header', $headerInfo);
   ...
   return NULL;	
	 ...
	 */
	function paginationCompress($link, $count, $perPage,$URI_SEGMENT,$segment=NULL) {
		$this->load->library ( 'pagination' );
		$this->load->helper('functions_helper');
		 $companyRecord=siteDetail();

		 if(isset($companyRecord->page_row))
		 {
			$perPage=$companyRecord->page_row;
